...
public class Keypad extends Dialog{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int element : useds){
        	if(element != 0){
        		...
        		// if number is used it's invisible or the same number cannot be typed twice
        	}
        }
        setListeners();
    }
    
    // findViews methods fetches and saves the view for all the keypad key
    ...
    // setListeners method set a listener for each keypad key
    ...
    //onKewDown method allows player to enter number from the keyboard
    ...
    // isValid methods check whether the given number is valid for current position
